...
| **Decision Fallback & Resilience**        | ✅ **Three-Engine Ladder**<br>Jev → heuristic → structured escalate; gracefully degrades                  | ❌ **Single Brain**<br>LLM timeout or failure blocks the whole loop                                | ❌ **N/A**<br>No local decision layer at all                                                 | ⚠️ **Model Retry**<br>Relies on upstream model availability                                      |
