    ...
    inputSchema: {
      ...
      properties: {
        ...
        background: {
          type: 'boolean',
          description:
            'Attempt capture without bringing tab/window to foreground. CDP-based capture is used for simple viewport captures. Default: false',
        },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        includeHttpOnly: {
          type: 'boolean',
          description: 'Include HttpOnly cookies (default true)',
        },
        tabId: { type: 'number', description: 'Target tab ID (optional)' },
        windowId: { type: 'number', description: 'Target window ID (optional)' },
        sessionId: { type: 'string', description: 'Session ID for tab affinity (optional)' },
